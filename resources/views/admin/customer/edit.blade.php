        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body justify-content-center">
                    <div class="col-sm-12 ">
                        <div class="card">
                        <div class="card-header"><strong>{{__('Update Customer')}}</strong></div>
                        ...
                        <input class="form-control" value="{{$customer->name}}" name="name" id="roomsname" type="text">
                        </div>

                        <div class="form-group">
                            <label class="form-col-form-label" for="inputSuccess1">{{__('Address')}}</label>
                            <input class="form-control" value="{{$customer->address}}" name="address" id="address" type="text">
                        </div>

                        <div class="form-group">
                            <label class="form-col-form-label" for="inputSuccess1">{{__('Contact no. ')}}</label>
                            <input class="form-control" value="{{$customer->mobile}}" name="mobile" id="mobile" type="text">
                        </div>
                        </div>
                        ...
                        <div class="card-body col mr-2">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="roomtype_id" name="roomtype_id">
                                    ...
                                    <option  value="{{$customer->roomtype_id}}"">{{$roomType->name}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="room_id" name="room_id">
                                    ...
                                    <option  value="{{$customer->room_id}}">{{$rooms->room_no}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control"  value="{{$customer->advance}}" name="advance" id="advance_amount" type="text">
                            </div>
